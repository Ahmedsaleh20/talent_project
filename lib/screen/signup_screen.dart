...
import 'package:talent_project/widgets/checkbox_widget.dart';
    ...
    return Scaffold(
      body: SafeArea(
        ...
        children: [
          ...
          StepperButton(mCancel: mCancel,mContinue: mContinue,), //stepper buttons
        ],
      )),
    );
  }
            ...
            content: Padding(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 5),
                      DefaultEmailField(controller: emailController,),
                      const SizedBox(
                        height: 15,
                      ),
                      const Text(
